...
save_dir = "Minigpt4_Multi_prompt_Multi_model"
...
adv_img = Image.open(image_path).convert('RGB')
adv_img_tensor = ToTensor()(adv_img).unsqueeze(0).to(device)  # Add batch dimension and move to device

image_emb_1, _ = model.model_1.encode_img(adv_img_tensor)
image_emb_2, _ = model.model_2.encode_img(adv_img_tensor)
image_emb_3, _ = model.model_3.encode_img(adv_img_tensor)
